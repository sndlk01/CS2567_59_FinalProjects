...
class TaRegularSheet implements FromCollection, WithTitle, ShouldAutoSize, WithStyles, WithColumnWidths, WithEvents
{
    ...
    public function collection()
    {
        ...
        // สรุปรวม
        $data->push(['']);
        $data->push(['รวมเป็นเงินทั้งสิ้น', number_format($this->compensation['regularPay'], 2), 'บาท', '', '= ' . $this->convertNumberToThaiBaht($this->compensation['regularPay']) . ' =', '', '', '', '']);
