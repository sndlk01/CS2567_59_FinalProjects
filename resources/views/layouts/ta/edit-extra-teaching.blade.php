...
@section('title', 'แก้ไขการลงเวลาการสอนชดเชย')
@section('break', 'แก้ไขการลงเวลาการสอนชดเชย')
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">แก้ไขการลงเวลาการสอนชดเชย</div>
                    <div class="card-body">
                        @if (session('error'))
                        ...
                        <form method="POST"
                            action="{{ route('extra-teaching.attendance.update', ['teaching_id' => $teaching->teaching_id]) }}">
                            @csrf
                            @method('PUT')
