...
<body>
    ...
    <!-- หน้าที่ 1: โครงการปกติ (แสดงเฉพาะเมื่อมีข้อมูล) -->
    @if ($hasRegularData)
        <!-- หลักฐานการจ่ายเงินอื่น ๆ (โครงการปกติ) -->
        ...
        <!-- เพิ่ม Page Break เมื่อมีทั้งข้อมูลโครงการปกติและโครงการพิเศษ -->
        @if ($hasSpecialData)
            <div class="page-break"></div>
        @endif
    @endif

    <!-- หน้าที่ 2: โครงการพิเศษ (แสดงเฉพาะเมื่อมีข้อมูล) -->
    @if ($hasSpecialData)
        <!-- หลักฐานการจ่ายเงินอื่น ๆ (โครงการพิเศษ) -->
        <h3>หลักฐานการจ่ายเงินอื่น ๆ</h3>
